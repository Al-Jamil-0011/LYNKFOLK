...
export function StoreBadges({ className }: StoreBadgesProps) {
  return (
    <div className={cn("flex flex-wrap items-center gap-3", className)}>
      ...
      <a
        href="#download"
        className="inline-flex items-center gap-2.5 rounded-xl bg-grey-900 px-4 py-2.5 text-white hover:bg-grey-800 transition-all shadow-sm group hover:scale-[1.02]"
